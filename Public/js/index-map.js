...
map.addControl(new BMap.NavigationControl({anchor: BMAP_ANCHOR_TOP_LEFT , type: BMAP_NAVIGATION_CONTROL_LARGE, offset: new BMap.Size(250, 60)})); 
...
var info_window = {
	...
	_show: function(longitude, latitude, content){
        ...
        $('.info-window-box').mousemove(function(e){ e.stopPropagation(); return false; })
	},
	hide: function(){
		var self = this;
