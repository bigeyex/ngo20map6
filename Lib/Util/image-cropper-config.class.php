...
$imgthumb=APP_PATH.'Public/Uploadedthumb/'; // folder for the uploads after cropping
$imgtemp=APP_PATH.'Runtime/Temp/'; // temp-folder before cropping
$imgbig=APP_PATH.'Public/Uploaded/'; // folder with big uploaded images
$webthumb=__APP__.'/Public/Uploadedthumb/';
$webbig=__APP__.'/Public/Uploaded/';
